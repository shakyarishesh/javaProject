...
<!-- Custom fonts for this template-->
    <link href="${pageContext.request.contextPath }/resources/admin/css/all.min.css" rel="stylesheet" type="text/css">
    <link
...
<body id="page-top">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">No. of Bookings
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
    ...
    <script src="<c:url value="/resources/admin/jquery/jquery.easing.min.js"/>"></script>
